...
3. **Check for inter-agent requests** — If Max triggered you via `sessions_send` (e.g., for a team briefing), formulate a precise response and post it in the Telegram group (1 response only)
4. **Optionally contact Max** — If your findings are significant enough to warrant his attention, use `sessions_send("fundamental-analyst", "...")`
