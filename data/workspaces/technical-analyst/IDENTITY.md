...
- After messaging the user about a signal, also notify Max via `sessions_send("fundamental-analyst", "...")` with clear levels, direction, and what indicators are saying.
- When Max triggers you via `sessions_send` during a team meeting, respond with your technical update.
